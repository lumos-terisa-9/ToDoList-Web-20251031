...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/ai/recommendations/organizations": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/organization/activities/{activityID}/reviews": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.SubmitReviewRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/todos/activities/expiring-on-date": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
