...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/organization/applications/join-organization": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/organization/applications/{id}/process": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/orgnization/application/pending-create": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "获取成功\" example({\"success\": true, \"message\": \"获取创建组织申请成功\"})",
                        "schema": {
                            "$ref": "#/definitions/handlers.SuccessResponse"
                        }
                    },
